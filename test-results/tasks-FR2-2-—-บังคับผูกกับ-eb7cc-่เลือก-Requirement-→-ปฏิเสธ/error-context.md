...
- Name: tasks.spec.ts >> FR2.2 — บังคับผูกกับ Requirement >> ไม่เลือก Requirement → ปฏิเสธ
- Location: e2e/tasks.spec.ts:60:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: มี Req แล้ว
        - generic [ref=f1e42]:
