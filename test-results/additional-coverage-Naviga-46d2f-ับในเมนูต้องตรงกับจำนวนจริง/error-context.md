...
- Name: additional-coverage.spec.ts >> Navigation — เมนูซ้าย >> ตัวเลขนับในเมนูต้องตรงกับจำนวนจริง
- Location: e2e/additional-coverage.spec.ts:146:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: Req 1
        - generic [ref=f1e42]:
