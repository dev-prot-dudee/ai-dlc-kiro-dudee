...
- Name: traceability-and-storage.spec.ts >> FR4.4 — Cascade delete Requirement >> ลบ Requirement → Task และ Defect ใต้มันต้องหายด้วย
- Location: e2e/traceability-and-storage.spec.ts:92:3
