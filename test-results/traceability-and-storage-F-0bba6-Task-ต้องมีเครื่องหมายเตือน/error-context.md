...
- Name: traceability-and-storage.spec.ts >> FR4.3 — Requirement ที่ยังไม่มี Task >> Requirement ที่ไม่มี Task ต้องมีเครื่องหมายเตือน
- Location: e2e/traceability-and-storage.spec.ts:78:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: Req ไม่มี Task
        - generic [ref=f1e42]:
