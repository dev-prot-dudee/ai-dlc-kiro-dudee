...
- Name: requirements.spec.ts >> FR1.2 — บังคับระบุประเภท >> ไม่เลือกประเภท → แสดง error ไม่บันทึก
- Location: e2e/requirements.spec.ts:47:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: ทดสอบไม่เลือกประเภท
        - generic [ref=f1e42]:
