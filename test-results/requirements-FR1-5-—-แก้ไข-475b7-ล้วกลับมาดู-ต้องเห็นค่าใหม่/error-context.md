...
- Name: requirements.spec.ts >> FR1.5 — แก้ไข Requirement >> แก้หัวข้อแล้วกลับมาดู ต้องเห็นค่าใหม่
- Location: e2e/requirements.spec.ts:97:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: ก่อนแก้
        - generic [ref=f1e42]:
