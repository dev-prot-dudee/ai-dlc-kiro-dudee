...
- Name: requirements.spec.ts >> FR1.6 — ลบ Requirement >> กดลบ → ยืนยัน → หายจากรายการ
- Location: e2e/requirements.spec.ts:118:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: จะลบทิ้ง
        - generic [ref=f1e42]:
