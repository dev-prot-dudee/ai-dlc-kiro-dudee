...
- Name: requirements.spec.ts >> FR1.4 — กรองและค้นหา >> เปลี่ยนเป็น List view แล้วกรองตามประเภท
- Location: e2e/requirements.spec.ts:79:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: FR ข้อหนึ่ง
        - generic [ref=f1e42]:
