...
- Name: requirements.spec.ts >> FR1.4 — กรองและค้นหา >> ค้นหาด้วยคำ → เห็นเฉพาะรายการที่ตรง
- Location: e2e/requirements.spec.ts:65:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: Login Feature
        - generic [ref=f1e42]:
