...
- Name: traceability-and-storage.spec.ts >> FR6.1 — ข้อมูลคงอยู่ข้าม session >> สร้างรายการ → refresh → ยังเห็นรายการเดิม
- Location: e2e/traceability-and-storage.spec.ts:118:3
    ...
    - generic [ref=f1e30]:
      ...
      - generic [ref=f1e37]:
        - generic [ref=f1e38]:
          ...
          - textbox "หัวข้อ (จำเป็น)" [active] [ref=f1e41]: ต้องอยู่หลัง refresh
        - generic [ref=f1e42]:
