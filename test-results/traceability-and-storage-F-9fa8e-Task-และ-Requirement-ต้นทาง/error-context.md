...
- Name: traceability-and-storage.spec.ts >> FR4.2 — สายย้อนกลับจาก Defect >> เปิด Defect → เห็น Task และ Requirement ต้นทาง
- Location: e2e/traceability-and-storage.spec.ts:66:3
